          ...
          >
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#1A1A1A] text-white py-4 hover:bg-[#C9A860] transition-colors"
                >
          ...
          >
            ...
            <div className="p-6 bg-[#1A1A1A] text-white">
              ...
              <a
                ...
                className="block text-center py-3 px-6 bg-[#C9A860] hover:bg-[#B8975A] transition-colors"
              >
                Call Emergency Line
              </a>
            </div>
